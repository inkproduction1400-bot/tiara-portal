      ...
      <div className="mx-auto max-w-6xl px-4">
        <div className="flex h-14 items-center gap-3">
          ...
          <div className="hidden sm:flex items-center gap-2">
            <Link
              href="/docs/swagger"
              className="rounded-md bg-zinc-900 px-3 py-1.5 text-sm font-medium text-white hover:opacity-90"
            >
              OpenAPI（Swagger）
            </Link>
            <Link
              href="/docs/api"
              className="rounded-md border px-3 py-1.5 text-sm font-medium text-zinc-800 hover:bg-zinc-100"
            >
              Redoc
            </Link>
          </div>
